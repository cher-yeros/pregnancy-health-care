 ...
 */
public class UpdateMotherFragment extends Fragment implements PopupMenu.OnMenuItemClickListener {

    private View view;
    private Mother prefMother;
    private EditText fullname,phone,email,age,username,password,cPassword;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_update_mother, container, false);
        initComponents();
    ...
    private void initComponents() {
        ...
        prefMother = new Gson().fromJson(jsonString,Mother.class);
        ...
        registerBtn.setOnClickListener(this::updateUser);
    }
    ...
    private void updateUser(View view) {
        ...
        if (!prefMother.getUsername().equals(sUsername)) {
            motherRef.child(prefMother.getUsername()).removeValue();
        }
...
//        });
    ...
    private void initFields() {
        String fullName = prefMother.getFullname();
        fullname.setText(fullName);
        phone.setText(prefMother.getPhone());
        age.setText(String.valueOf(prefMother.getAge()));
        username.setText(prefMother.getUsername());
    }
