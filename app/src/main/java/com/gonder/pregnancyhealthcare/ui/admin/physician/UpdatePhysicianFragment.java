 ...
 */
public class UpdatePhysicianFragment extends Fragment {


    private Physician prefPhysician;
    private View view;
    ...
    public UpdatePhysicianFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_update_physician, container, false);
        initComponents();
        initFields();
        return view;
    }
    ...
    private void initComponents() {
        ...
        prefPhysician = new Gson().fromJson(jsonString, Physician.class);
    ...
    private void updateUser(View view) {
        ...
        if (!prefPhysician.getUsername().equals(sUsername)) {
            docRef.child(prefPhysician.getUsername()).removeValue();
        }
    ...
    private void initFields() {
        String fullName = prefPhysician.getFullname();
        fullname.setText(fullName);
        phone.setText(prefPhysician.getPhone());
        username.setText(prefPhysician.getUsername());
        password.setText(prefPhysician.getPassword());
        cPassword.setText(prefPhysician.getPassword());
    }
