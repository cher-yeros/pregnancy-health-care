...
import com.gonder.pregnancyhealthcare.adapters.ReportListAdapter;
import com.gonder.pregnancyhealthcare.models.Report;

import java.util.ArrayList;

public class SendUpdatedReportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_send_updated_report);
        ...
        reportRV = findViewById(R.id.report_recycler_view);
        layoutManager = new LinearLayoutManager(this);
        reportRV.setLayoutManager(layoutManager);


        ReportListAdapter listAdapter = new ReportListAdapter(this, reports);
