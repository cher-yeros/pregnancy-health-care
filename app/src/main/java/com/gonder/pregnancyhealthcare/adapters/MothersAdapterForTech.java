...
import com.gonder.pregnancyhealthcare.ui.technician.GenerateLabReportActivity;
import com.google.gson.Gson;

import java.util.ArrayList;

public class MothersAdapterForTech extends RecyclerView.Adapter<MothersAdapterForTech.MyViewHolder> {
    private ArrayList<Mother> mothers;
    private Context context;

    public MothersAdapterForTech(ArrayList<Mother> mothers, Context context) {
...
//        ImageView imageThumb = holder.imageThumb;
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            Intent i = new Intent(context, GenerateLabReportActivity.class);
            i.putExtra("mother",new Gson().toJson(mother));
